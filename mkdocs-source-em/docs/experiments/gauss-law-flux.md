...
<text x="320" y="330" text-anchor="middle" font-size="12.5" fill="#274" font-family="Inter,Helvetica,sans-serif">A virtual charge enclosed within a draggable/resizable Gaussian</text>
<text x="320" y="348" text-anchor="middle" font-size="12.5" fill="#274" font-family="Inter,Helvetica,sans-serif">surface (sphere, cube or cylinder); the simulator numerically</text>
<text x="320" y="366" text-anchor="middle" font-size="12.5" fill="#274" font-family="Inter,Helvetica,sans-serif">integrates E·dA over the chosen surface and displays the running</text>
<text x="320" y="384" text-anchor="middle" font-size="12.5" fill="#274" font-family="Inter,Helvetica,sans-serif">flux total.</text>
</svg>
<div class="apparatus-3d-caption"><b>Apparatus schematic</b> &middot; A virtual charge enclosed within a draggable/resizable Gaussian surface (sphere, cube or cylinder); the simulator numerically integrates E·dA over the chosen surface and displays the running flux total.</div>
</div>
