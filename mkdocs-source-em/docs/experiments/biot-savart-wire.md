...
<text x="320" y="330" text-anchor="middle" font-size="12.5" fill="#274" font-family="Inter,Helvetica,sans-serif">A virtual straight current-carrying wire of adjustable length</text>
<text x="320" y="348" text-anchor="middle" font-size="12.5" fill="#274" font-family="Inter,Helvetica,sans-serif">and current, with a field probe that can be placed at any</text>
<text x="320" y="366" text-anchor="middle" font-size="12.5" fill="#274" font-family="Inter,Helvetica,sans-serif">perpendicular distance a; the simulator numerically integrates</text>
<text x="320" y="384" text-anchor="middle" font-size="12.5" fill="#274" font-family="Inter,Helvetica,sans-serif">the Biot–Savart law along the wire's length.</text>
</svg>
<div class="apparatus-3d-caption"><b>Apparatus schematic</b> &middot; A virtual straight current-carrying wire of adjustable length and current, with a field probe that can be placed at any perpendicular distance a; the simulator numerically integrates the Biot–Savart law along the wire's length.</div>
</div>
