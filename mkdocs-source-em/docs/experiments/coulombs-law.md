...
<text x="320" y="330" text-anchor="middle" font-size="12.5" fill="#274" font-family="Inter,Helvetica,sans-serif">A torsion-balance (Coulomb balance) analogue: a charged pith</text>
<text x="320" y="348" text-anchor="middle" font-size="12.5" fill="#274" font-family="Inter,Helvetica,sans-serif">ball on a torsion fibre is deflected by a second charged ball</text>
<text x="320" y="366" text-anchor="middle" font-size="12.5" fill="#274" font-family="Inter,Helvetica,sans-serif">brought to a variable separation r on an insulating rail; the</text>
<text x="320" y="384" text-anchor="middle" font-size="12.5" fill="#274" font-family="Inter,Helvetica,sans-serif">fibre's restoring torque at equilibrium is proportional to F.</text>
</svg>
<div class="apparatus-3d-caption"><b>Apparatus schematic</b> &middot; A torsion-balance (Coulomb balance) analogue: a charged pith ball on a torsion fibre is deflected by a second charged ball brought to a variable separation r on an insulating rail; the fibre's restoring torque at equilibrium is proportional to F.</div>
</div>
